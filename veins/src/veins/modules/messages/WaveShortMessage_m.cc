...
int WaveShortMessageDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "senderSpeed")==0) return base+13;
    if (fieldName[0]=='t' && strcmp(fieldName, "timestamp")==0) return base+14;
...
std::string WaveShortMessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 13: {std::stringstream out; out << pp->getSenderSpeed(); return out.str();}
        case 14: return double2string(pp->getTimestamp());
        default: return "";
    }
}
...
void *WaveShortMessageDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 13: return (void *)(&pp->getSenderSpeed()); break;
        default: return NULL;
    }
}
